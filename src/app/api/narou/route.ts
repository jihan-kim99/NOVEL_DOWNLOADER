...
async function handleNarouInfo(
  ...
  // Fetch the main page to get the title, as episode 1 might be missing or redirect
  const infoUrl = `https://${domain}/${bookId}/`;
  console.log(`[INFO] Fetching Narou info from: ${infoUrl}`);
